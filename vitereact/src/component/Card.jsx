...
function CompanyCard({ company, onDelete, onEdit, mode }) {
  ...
  try {
    const res = await fetch(`http://localhost:3000/schedule-notification`, {
      method: "POST",
      headers: {
    ...
    >
      ...
      {showEmailForm && (
        <div className="fixed inset-0 flex items-center justify-center bg-black/70 z-50 p-4">
          <div className={`p-6 rounded-lg shadow-xl w-full max-w-sm border ${modalBg} ${
              mode === "dark" ? "border-cyan-500/30" : "border-blue-300"
          }`}>
            ...
            <input
              ...
              className={`w-full border p-2 mb-4 rounded font-mono ${
                  mode === "dark" ? "bg-gray-700 text-white border-gray-600" : "bg-gray-100 text-gray-800 border-gray-300"
              }`}
        ...
        <div className={`flex-1 p-4 sm:p-6 ${rightPanelBg}`}>
          <div className="relative mb-4 sm:mb-6">
            <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start mb-4 space-y-4 lg:space-y-0">
                ...
                >
                  <span
                    className={`flex-shrink-0 ${
                      mode === "dark" ? "text-green-500" : "text-emerald-600"
                    }`}
                  >
                    location:
                  </span>
              ...
              >
                <div
                  className={`px-3 py-1 text-xs font-mono flex items-center justify-center ${
                    mode === "dark"
                ...
                <div className="p-3 text-center">
                  <div
                    className={`text-lg font-mono font-bold ${
                      mode === "dark" ? "text-green-500" : "text-emerald-700"
                    }`}
                  >
                    {company.ctc}
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
              ...
              />
              <div
                className={`font-mono text-s mb-1 ${
            ...
            >
              ...
              />
              <div
                className={`font-mono text-s mb-1 uppercase ${
