...
function CompanyCard({ company, onDelete, onEdit, mode }) {
  ...
  return (
    <div
      className={`relative rounded-2xl border overflow-hidden group transition-all duration-500 hover:shadow-2xl transform hover:scale-[1.02] ${cardBg} ${
        mode === "dark" ? "hover:shadow-cyan-500/20" : "hover:shadow-blue-500/25"
      }`}
    >
      {/* Card container */}
      <div className="relative flex flex-col lg:flex-row min-h-[16rem] lg:min-h-[18rem]">
        ...
        >
          ...
          <div className="absolute top-3 right-3 flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2 opacity-0 group-hover:opacity-100 transition-all duration-300">
            <button
              onClick={handleEdit}
              className={`backdrop-blur-sm rounded-lg w-8 h-8 flex items-center justify-center text-s font-mono border transition-all duration-200 ${
                mode === "dark"
          ...
          <div className="relative z-10 text-center px-3 py-4">
            ...
            >
              ...
              />
              <span
                className={`text-xl sm:text-2xl lg:text-3xl font-mono font-bold relative z-10 ${
              ...
              <div
                className={`absolute bottom-1 right-1 lg:bottom-2 lg:right-2 w-1 h-2 lg:h-3 animate-pulse ${
            ...
            >
              <div className="truncate">
                <span
                  className={`font-mono text-s sm:text-sm ${
                ...
                <span
                  className={`font-mono text-sm sm:text-base lg:text-lg font-bold ${
            ...
            <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start mb-4 space-y-4 lg:space-y-0">
              <div className="flex-1 min-w-0">
                <div className={`font-mono text-s sm:text-sm ${textSecondary} mb-1`}>
                  ...
                  <span className={mode === "dark" ? "text-cyan-500" : "text-blue-600"}>
                    Role
                  </span>{" "}
                  {"{"}
                </div>
                <h3 className={`text-lg sm:text-xl font-mono font-bold ml-2 sm:ml-4 mb-2 break-words ${textPrimary}`}>
                  "{company.role}"
                </h3>
                <div className={`font-mono text-s sm:text-sm mb-2 ${textSecondary}`}>{"}"}</div>

                {/* Location */}
                <div className={`flex items-center font-mono text-s sm:text-sm break-all font-bold ${textSecondary}`}>
                  <span className={`flex-shrink-0 ${mode === "dark" ? "text-green-500" : "text-emerald-600"}`}>
                    location:
                  </span>
                  <span className={`${textPrimary} ml-2 break-all`}>"{company.location}"</span>
                </div>
              </div>

              {/* CTC */}
              <div className={`rounded-lg overflow-hidden w-full lg:w-auto lg:min-w-[100px] flex-shrink-0 ${ctcContainerBg} shadow-sm`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div
              className={`rounded-lg p-4 relative overflow-hidden border ${
                mode === "dark" ? "bg-red-900/20 border-red-500/40" : "bg-red-50 border-red-300"
              }`}
            >
            ...
            <div
              className={`rounded-lg p-4 relative overflow-hidden border ${
                mode === "dark" ? "bg-blue-900/20 border-blue-500/40" : "bg-blue-50 border-blue-300"
              }`}
            >
              ...
              <div className="flex justify-between items-center">
                ...
                <span
                  className={`font-mono text-s px-2 py-1 rounded ${
                    mode === "dark"
            ...
            {/* Interview */}
            <div
              className={`rounded-lg p-4 relative overflow-hidden md:col-span-2 border ${
                mode === "dark" ? "bg-green-900/20 border-green-500/40" : "bg-emerald-50 border-emerald-300"
              }`}
            >
              ...
              <div className="flex justify-between items-center">
                ...
                <div
                  className={`font-mono text-s px-3 py-1 rounded border ${
                    mode === "dark"
